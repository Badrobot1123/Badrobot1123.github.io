...
draw.fillRect(4*unit,9*unit,1*unit,4*unit);
    ...
    draw.fillRect(4*unit,10*unit,7*unit,2*unit);
    draw.fillRect(3*unit,11*unit,1*unit,2*unit);
    draw.fillRect(5*unit,12*unit,1*unit,1*unit);
    draw.fillRect(7*unit,12*unit,3*unit,1*unit);
...
draw.fillRect(4*unit,7*unit,4*unit,2*unit);
    draw.fillRect(5*unit,9*unit,5*unit,1*unit);
    ...
    draw.fillRect(2*unit,10*unit,2*unit,1*unit);
    draw.fillRect(2*unit,10*unit,1*unit,3*unit);
    draw.fillRect(1*unit,12*unit,1*unit,2*unit);
    draw.fillRect(6*unit,13*unit,3*unit,2*unit);
...
draw.fillRect(4*unit,3*unit,1*unit,2*unit);
    draw.fillRect(11*unit,7*unit,1*unit,3*unit);
