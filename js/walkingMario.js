function drawWalkingMario(){
    ...
    draw.fillRect(4*unit,7*unit,2*unit,5*unit);
    draw.fillRect(3*unit,8*unit,1*unit,3*unit);
    draw.fillRect(7*unit,7*unit,3*unit,1*unit);
    draw.fillRect(9*unit,8*unit,2*unit,1*unit);
    ...
    draw.fillRect(5*unit,14*unit,4*unit,2*unit);
    draw.fillRect(8*unit,13*unit,3*unit,2*unit);
    draw.fillRect(11*unit,14*unit,1*unit,1*unit);
...
draw.fillRect(4*unit,3*unit,1*unit,2*unit);
    ...
    draw.fillRect(6*unit,11*unit,2*unit,2*unit);
    draw.fillRect(8*unit,11*unit,1*unit,1*unit);
    draw.fillRect(8*unit,9*unit,4*unit,1*unit);
    //draw.fillRect(*unit,*unit,*unit,*unit);
    //draw.fillRect(*unit,*unit,*unit,*unit);
    //draw.fillRect(*unit,*unit,*unit,*unit);
    //draw.fillRect(*unit,*unit,*unit,*unit);
    ...
    draw.fillRect(7*unit,8*unit,2*unit,1*unit);
    draw.fillRect(6*unit,9*unit,2*unit,1*unit);
    draw.fillRect(9*unit,9*unit,2*unit,4*unit);
    draw.fillRect(7*unit,10*unit,2*unit,1*unit);
    draw.fillRect(9*unit,10*unit,3*unit,2*unit);
    draw.fillRect(5*unit,13*unit,3*unit,1*unit);
     draw.fillRect(8*unit,12*unit,1*unit,1*unit);
